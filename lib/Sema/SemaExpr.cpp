  ...
  case Type::STK_Nan:
      switch (DestTy->getScalarTypeKind()) {
        ...
        case Type::STK_Integral: {
          ...
          Src = ImpCastExprToType(Src.take(), ET, CK_NanToIntegral);
          return CK_IntegralCast;
        }
        case Type::STK_Bool:
        ...
        case Type::STK_Floating:
          Src = ImpCastExprToType(Src.take(),
                                  SrcTy->castAs<NanType>()->getElementType(),
                                  CK_NanToIntegral);
          return CK_IntegralToFloating;
        case Type::STK_CPointer:
        case Type::STK_ObjCObjectPointer:
        case Type::STK_BlockPointer:
          llvm_unreachable("valid nan int->pointer cast?");
        case Type::STK_MemberPointer:
          llvm_unreachable("member pointer type in C");
      }
      llvm_unreachable("Should have returned before this");    
  ...
  */
  case Type::STK_Floating:
    ...
    case Type::STK_IntegralComplex:
      ...
      return CK_IntegralRealToComplex;
    case Type::STK_Nan:
      llvm_unreachable("invalid float->nan cast");
    case Type::STK_CPointer:
    case Type::STK_ObjCObjectPointer:
    case Type::STK_BlockPointer:
  ...
  case Type::STK_FloatingComplex:
    ...
    case Type::STK_Nan:
      llvm_unreachable("invalid float complex->nan cast");
    case Type::STK_Floating: {
  ...
  case Type::STK_IntegralComplex:
    ...
    case Type::STK_Nan:
      llvm_unreachable("invalid integer complex->nan cast");
    case Type::STK_Integral: {
      QualType ET = SrcTy->castAs<ComplexType>()->getElementType();
      if (Context.hasSameType(ET, DestTy))
